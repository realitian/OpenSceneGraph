...
-DFREETYPE_INCLUDE_DIR_freetype2:PATH="3rdParty/ios/freetype/include/freetype" \
-DFREETYPE_INCLUDE_DIR_ft2build:PATH="3rdParty/ios/freetype/include" \
-DFREETYPE_LIBRARY:PATH="3rdParty/ios/freetype/lib/libfreetype.a" \
-DCURL_INCLUDE_DIRS:PATH="3rdParty/ios/libcurl" \
